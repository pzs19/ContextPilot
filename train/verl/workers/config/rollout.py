...
class MultiTurnConfig(BaseConfig):
    ...
    single_turn_max_tokens: int = 1024
    exceed_length_penalty: float = -1.0
    max_samples_per_trajectory: int = 1
    downsample_mode: str = "last"
    
    dump_trajectories_enabled: bool = False
    dump_trajectories_dir: str = "trajectories"
    dump_trajectories_freq: int = 1
    min_assistant_turns: Optional[int] = None
    below_min_turns_reward: float = -1.0
    model_type: str = "qwen3"

    contextpilot: dict = field(default_factory=dict)
